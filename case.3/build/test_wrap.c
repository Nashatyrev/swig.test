...
SWIGEXPORT void JNICALL Java_testJNI_scalar_1arr_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
...
SWIGEXPORT jlong JNICALL Java_testJNI_scalar_1arr_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  scalar *arg1 = (scalar *) 0 ;
  uint64_t *result = 0 ;
