...
SWIGEXPORT void JNICALL Java_testJNI_scalar_1arr_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlongArray jarg2) {
  scalar *arg1 = (scalar *) 0 ;
  uint64_t *arg2 ;
  jlong *jarr2 ;
...
SWIGEXPORT jlongArray JNICALL Java_testJNI_scalar_1arr_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  (void)jarg1_;
  arg1 = *(scalar **)&jarg1; 
  result = (uint64_t *)(uint64_t *) ((arg1)->arr);
  jresult = SWIG_JavaArrayOutUlong(jenv, (unsigned long *)result, 4); 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_testJNI_new_1scalar(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  scalar *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (scalar *)calloc(1, sizeof(scalar));
  *(scalar **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_testJNI_delete_1scalar(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  scalar *arg1 = (scalar *) 0 ;
...
SWIGEXPORT void JNICALL Java_testJNI_fun1(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  scalar *arg1 = (scalar *) 0 ;
...
SWIGEXPORT void JNICALL Java_testJNI_fun2(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  scalar arg1 ;
  scalar *argp1 ;
  ...
  argp1 = *(scalar **)&jarg1; 
  if (!argp1) {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "Attempt to dereference null scalar");
    return ;
  }
  arg1 = *argp1; 
  fun2(arg1);
